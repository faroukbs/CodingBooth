...
Image imgg = null;
    ...
    public ListProd(Resources res) {
     ...
     //   final Dialog ipDlg = ip.showInifiniteBlocking();
        ...
        ListProduct a = new ListProduct(current);
            a.show();
        ...
        ArrayList<Product> prodlist = ServiceProduct.getInstance().getAllProduct();
        ...
        for (Product p : prodlist) {
            ImageViewer photo = new ImageViewer();
             ...
             MultiButton sp = new MultiButton(p.getNomprod());
                      
             sp.setIcon(i.fill(200,200));
              sp.setTextLine1("nomprod: "+p.getNomprod()+" description : "+p.getDescription());
...
//                     });
    ...
    ListProd(Form current) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
     private void addButton(Image img, String nomprod, String description ,Product p, boolean liked, int likeCount, int commentCount) {
       ...
       cnt.setLeadComponent(image);
        ...
        Label titreTxt = new Label("id : "+p.getIdProduit(),"NewsTopLine2");
        Label villeTxt = new Label("nomprod : "+p.getNomprod(),"NewsTopLine2" );
       ...
       add(cnt);
       image.addActionListener(e -> ToastBar.showMessage(nomprod, FontImage.MATERIAL_INFO));
   }
