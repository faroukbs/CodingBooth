...
import com.mycompany.gui.ModifierCommandeForm;
...
public class ListCommandeForm  extends BaseForm{
    ...
    public ListCommandeForm (Resources res ) {
        ...
        ArrayList<Commande>list = ServiceCommande.getInstance().affichageCommande();
    ...
    private void addButton(Image img,Commande rec , Resources res) {
        ...
        Label nomTxt = new Label("Nom : "+rec.getNom_client(),"NewsTopLine2");
        Label prenomTxt = new Label("Prenom : "+rec.getPrenom_client(),"NewsTopLine2");
        Label telephoneTxt = new Label("Telephone : "+rec.getTelephone(),"NewsTopLine2");
        ...
        Label modeTxt = new Label("Mode paiement : "+rec.getMode_paiement(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce commande ?","Annuler","Oui")) {
                ...
                if(ServiceCommande.getInstance().deleteCommande(rec.getIdcommande())) {
        ...
        lModifier.addPointerPressedListener(l -> {
         ...
         new ModifierCommandeForm(res,rec).show();
        });
