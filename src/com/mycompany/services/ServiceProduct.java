...
public class ServiceProduct {
    ...
    public boolean addProduct(Product p) {
        ...
        System.out.println("********");
        String url = Statics.BASE_URL +"/product/newmob?nomprod=" + p.getNomprod()+"&description=" +p.getDescription()+"&image=" + p.getImage()+"&prix=" + p.getPrix()+"&quantity=" + p.getQuantity();
    ...
    public ArrayList<Product> getAllProduct() {
        ...
        String url = Statics.BASE_URL + "/product/listmob";
     ...
     public Product Detailprod( int idProduit , Product p) {
        ...
        String url = Statics.BASE_URL+"/product/listmob=?"+idProduit;
        req.setUrl(url);
       ...
       String url = Statics.BASE_URL + "/product/Deletemob/"+idproduit;
    ...
    public boolean modifierProduct(Product p) {
         String url = Statics.BASE_URL +"/editmob?id_produit="+p.getIdProduit()+"&nomprod=" + p.getNomprod()+"&description=" +p.getDescription()+"&image=" + p.getImage()+"&prix=" + p.getPrix()+"&quantity=" + p.getQuantity();
