...
import com.gogym.gui.InboxForm;
import com.gogym.gui.Profil;
import com.gogym.utils.Statics;

import com.gogym.gui.SessionManager;
import com.gogym.gui.SignInForm;
  ...
  //singleton 
   ...
   /* if (s.equals("succés"))
    ...
    NetworkManager.getInstance().addToQueueAndWait(req);
        ...
        String url = Statics.BASE_URL + "/deleteuserr?id="+id;
        req.setUrl(url);
