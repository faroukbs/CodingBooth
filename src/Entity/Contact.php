...
class Contact
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Reponse::class, mappedBy="contact", cascade={"persist", "remove"})
     */
    private $reponse;

    /**
     * @ORM\ManyToOne(targetEntity=Utilisateurs::class, inversedBy="contact")
     */
    private $client;
    ...
    public function setReponse(?Reponse $reponse): self
    {
        ...
        if ($reponse === null && $this->reponse !== null) {
            $this->reponse->setContact(null);
        }

        // set the owning side of the relation if necessary
        if ($reponse !== null && $reponse->getContact() !== $this) {
