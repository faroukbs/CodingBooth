 ...
 */
final class Version20220213120819 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, id_matiere INT NOT NULL, Date DATE NOT NULL, TimeDeb TIME NOT NULL, TimeFin TIME NOT NULL, INDEX id_matier (id_matiere), INDEX id_user (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE classeenseignantmatiere (id_class INT NOT NULL, id_user INT NOT NULL, id_matiere INT NOT NULL, INDEX FK_USER (id_user), INDEX FK_Matiere (id_matiere), INDEX FK_classqqs (id_class)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
