 ...
 * @author ahmed
 */
public class AjoutSalle extends BaseFormBack {
      Form current;
        int Oxeeeeee;
        public AjoutSalle (Resources res){
     ...
     Toolbar tb=new Toolbar(true);
        ...
        addOrientationListener(e -> {
         ...
         TextField idcategorie=new TextField("","ENTER categorie");
            idcategorie.setUIID("TextFieldBlack");
            addStringValue("idcategorie",idcategorie);
            TextField nomsalle=new TextField("","ENTER NOM salle");
            nomsalle.setUIID("TextFieldBlack");
            addStringValue("nomsalle",nomsalle);
     ...
     btnAjouter.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent l) {
             try{
                 if(nomsalle.getText().equals("") || description.getText().equals("")|| idcategorie.getText().equals("")){
                     ...
                     final Dialog iDialog = ip.showInfiniteBlocking();
                             Salle s = new Salle(nomsalle.getText(),description.getText(),Integer.parseInt(idcategorie.getText()));
                  
                     System.out.println(" data evenement" +s);
                     ServiceSalle.getInstance().ajoutersalle(s);
                     iDialog.dispose();
