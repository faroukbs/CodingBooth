...
public class Ticketf  extends BaseForm{
    ...
    public Ticketf (Resources res ) {
        ...
        ArrayList<Ticket>list = ServiceTicket.getInstance().affichageticket();
    ...
    private void addButton(Image img,Ticket ticket , Resources res) {
       ...
       //supprimer button
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce ticket ?","Annuler","Oui")) {
                ...
                if(ServiceTicket.getInstance().deleteticket(ticket.getIdticket())) {
