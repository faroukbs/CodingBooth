 ...
 * @author ahmed
 */
public class AjoutCategorie extends BaseFormBack {
          Form current;
        int Oxeeeeee;
     ...
     Toolbar tb=new Toolbar(true);
        ...
        addOrientationListener(e -> {
            ...
            TextField nomcategorie=new TextField("","ENTER NOM categorie");
             ...
             try{
                 if(nomcategorie.getText().equals("")){
                     ...
                     final Dialog iDialog = ip.showInfiniteBlocking();
                             Categorie c = new Categorie(nomcategorie.getText());
